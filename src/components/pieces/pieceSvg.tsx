...
// Cburnett piece set (Colin M.L. Burnett, GPLv2+), sourced verbatim from
// lila (lichess.org) at public/piece/cburnett/{color}{TYPE}.svg. See
// README.md "Piece art" for attribution details. No Unicode glyphs are
// used.
...
function WhitePawn(): JSX.Element {
  return (
    <path
      fill="#fff"
      stroke="#000"
...
function WhiteKnight(): JSX.Element {
  return (
    <g
      fill="none"
      fill-rule="evenodd"
...
function WhiteBishop(): JSX.Element {
  return (
    <g
      fill="none"
      fill-rule="evenodd"
...
function WhiteRook(): JSX.Element {
  return (
    <g
      fill="#fff"
      fill-rule="evenodd"
...
function WhiteQueen(): JSX.Element {
  return (
    <g
      fill="#fff"
      fill-rule="evenodd"
...
function WhiteKing(): JSX.Element {
  return (
    <g
      fill="none"
      fill-rule="evenodd"
...
function BlackPawn(): JSX.Element {
  return (
    <path
      stroke="#000"
      stroke-linecap="round"
...
function BlackKnight(): JSX.Element {
  return (
    <g
      fill="none"
      fill-rule="evenodd"
...
function BlackBishop(): JSX.Element {
  return (
    <g
      fill="none"
      fill-rule="evenodd"
...
function BlackRook(): JSX.Element {
  return (
    <g
      fill-rule="evenodd"
      stroke="#000"
...
function BlackQueen(): JSX.Element {
  return (
    <g
      fill-rule="evenodd"
      stroke="#000"
...
function BlackKing(): JSX.Element {
  return (
    <g
      fill="none"
      fill-rule="evenodd"
